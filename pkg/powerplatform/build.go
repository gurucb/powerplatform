...
func (m *Mixin) Build(ctx context.Context) error {
	...
	fmt.Fprintln(m.Out, `RUN curl -H 'Accept: application/vnd.github.v3.raw' "https://${GITHUB_TOKEN}@raw.githubusercontent.com/hemantkathuria/privatemixintest/main/mixins/powerplatform/v0.0.1/cli/PowerPlatformClient" -o "/cnab/app/PowerPlatformClient"`)
	fmt.Fprintln(m.Out, `RUN chmod 777 /cnab/app/PowerPlatformClient`)
